...
export class Migration1771341191144 implements MigrationInterface {
    name = 'Migration1771341191144'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."subscriptions_newsletter_enum" AS ENUM('ai', 'founder', 'marketer')`);
